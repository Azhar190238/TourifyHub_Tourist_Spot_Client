...
const AddSpot = () => {
    ...
    return (
        <div>
            <form onSubmit={handleAddSpot} className="bg-[#F4F3F0] mx-5 md:mx-20 lg:mx-40 my-10">
                <h1 className="pt-10 text-center font-sans text-3xl md:text-5xl">Add New Tourist Spot</h1>
                <p className="pt-4 text-center px-10 lg:px-40"> Exploring a new tourist spot is like unwrapping a gift filled with surprises. May each adventure bring you joy, wonder, and unforgettable memories</p>
